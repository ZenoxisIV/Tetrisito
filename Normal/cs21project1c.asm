...
# cs21project1c.asm --  a MIPS program that FULLY implements Tetrisito - a modified Tetris solver
...
# (3) This MIPS program is in reference with the Python code mp1c.py
...
addiu $t7, $t2, 24 # skip 4 empty rows for falling piecee
